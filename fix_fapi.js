...
s = s.replace(
  /export const getMonthlyReport = \(year: number, month: number, page\?: number, limit\?: number\) => \{\r?\n\s*let url = `\/workers\/reports\/monthly\?year=\$\{year\}&month=\$\{month\}`;/,
